      ...
      <ion-content>
        <div id="login-container">
          <div id="login-form">
            ...
            <InputComponent type="marca" id="marca" name="marca" label="marca: " />
            <InputComponent id="descripcion" name="descripcion" label="descripcion: " />
...
// Rutas de la API
const baseURL = 'http://localhost:8085/api/categoria';
